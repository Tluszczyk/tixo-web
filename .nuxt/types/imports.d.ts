...
export {}
declare global {
  const AI_MODELS: typeof import('../../utils/engine').AI_MODELS
  const GameState: typeof import('../../utils/engine').GameState
  const MacroState: typeof import('../../utils/engine').MacroState
  const Player: typeof import('../../utils/engine').Player
  ...
  const check3x3Winner: typeof import('../../utils/gameLogic').check3x3Winner
  ...
  const evaluateBoard: typeof import('../../utils/engine').evaluateBoard
  const formatStatus: typeof import('../../utils/gameLogic').formatStatus
  ...
  const indexToCoord: typeof import('../../utils/gameLogic').indexToCoord
  const inject: typeof import('vue').inject
  const injectHead: typeof import('../../node_modules/nuxt/dist/app/composables/head').injectHead
  const isCellAvailable: typeof import('../../utils/gameLogic').isCellAvailable
  ...
  const minimax: typeof import('../../utils/engine').minimax
  ...
  const rebuildGameState: typeof import('../../utils/gameLogic').rebuildGameState
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { Player, MacroState, GameState, GameResult, EvaluationWeights, AIModel } from '../../utils/engine'
  import('../../utils/engine')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly AI_MODELS: UnwrapRef<typeof import('../../utils/engine')['AI_MODELS']>
    readonly GameState: UnwrapRef<typeof import('../../utils/engine')['GameState']>
    readonly MacroState: UnwrapRef<typeof import('../../utils/engine')['MacroState']>
    readonly Player: UnwrapRef<typeof import('../../utils/engine')['Player']>
    ...
    readonly check3x3Winner: UnwrapRef<typeof import('../../utils/gameLogic')['check3x3Winner']>
    ...
    readonly evaluateBoard: UnwrapRef<typeof import('../../utils/engine')['evaluateBoard']>
    readonly formatStatus: UnwrapRef<typeof import('../../utils/gameLogic')['formatStatus']>
    ...
    readonly indexToCoord: UnwrapRef<typeof import('../../utils/gameLogic')['indexToCoord']>
    readonly inject: UnwrapRef<typeof import('vue')['inject']>
    readonly injectHead: UnwrapRef<typeof import('../../node_modules/nuxt/dist/app/composables/head')['injectHead']>
    readonly isCellAvailable: UnwrapRef<typeof import('../../utils/gameLogic')['isCellAvailable']>
    ...
    readonly minimax: UnwrapRef<typeof import('../../utils/engine')['minimax']>
    ...
    readonly rebuildGameState: UnwrapRef<typeof import('../../utils/gameLogic')['rebuildGameState']>
