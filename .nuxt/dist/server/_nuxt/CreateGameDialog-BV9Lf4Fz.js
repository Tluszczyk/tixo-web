...
import { u as users, g as games } from "./games-aIlt4Osa.js";
                ...
                _push2(ssrRenderComponent(_component_CommonBaseButton, {
                  ...
                  default: withCtx((_, _push3, _parent2, _scopeId) => {
                    if (_push3) {
                      ...
                      ])}"${_scopeId}><i class="pi pi-android text-sm"${_scopeId}></i></div><div${_scopeId}><p class="${ssrRenderClass([selectedBotId.value === bot.$id ? "text-purple-400" : "text-app-text", "font-black text-[10px] uppercase tracking-widest"])}"${_scopeId}>${ssrInterpolate(bot.name)}</p><p class="text-[8px] uppercase font-black text-app-text-muted opacity-40"${_scopeId}>${ssrInterpolate(bot.prefs?.modelName?.toLowerCase() || "Heuristic")} AI </p></div></div><div class="text-right"${_scopeId}><p class="text-[10px] font-black text-purple-500"${_scopeId}>${ssrInterpolate(bot.rating || 1500)}</p><p class="text-[8px] text-app-text-muted opacity-40 uppercase tracking-tighter"${_scopeId}>Rating</p></div>`);
                    } else {
                      return [
                        createVNode("div", { class: "flex items-center space-x-3" }, [
                          ...
                          createVNode("div", null, [
                            ...
                            createVNode("p", { class: "text-[8px] uppercase font-black text-app-text-muted opacity-40" }, toDisplayString(bot.prefs?.modelName?.toLowerCase() || "Heuristic") + " AI ", 1)
                          ])
                        ]),
