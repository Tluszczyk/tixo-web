...
import { hasProtocol, joinURL, withQuery, parseURL, encodePath, decodePath, isScriptProtocol } from "/home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/ufo/dist/index.mjs";
...
import { Functions, TablesDB, Account, Client, AppwriteException, ExecutionMethod, Query } from "appwrite";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/index-BVFGZpIN.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$6 || {},
    component: () => import("./_nuxt/login-DAxg831D.js")
  },
  {
    name: "users",
    path: "/users",
    meta: __nuxt_page_meta$5 || {},
    component: () => import("./_nuxt/users-B7kbIESG.js")
  },
  {
    name: "profile",
    path: "/profile",
    meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": "auth" } },
    component: () => import("./_nuxt/profile-D4BAHUaq.js")
  },
  {
    name: "dashboard",
    path: "/dashboard",
    meta: __nuxt_page_meta$3 || {},
    component: () => import("./_nuxt/dashboard-CGh9sSCw.js")
  },
  {
    name: "game-id",
    path: "/game/:id()",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/_id_-Bb13POff.js")
  },
  {
    name: "how-to-play",
    path: "/how-to-play",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/how-to-play-pUO_hJuD.js")
  },
  {
    name: "analysis-id",
    path: "/analysis/:id()",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/_id_-zDcf8YyO.js")
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-I8vAWqko.js"),
...
const LazyAutoComplete = defineAsyncComponent(() => import("./_nuxt/index-ZH-axcya.js").then((r) => r["default"] || r.default || r));
const LazyCalendar = defineAsyncComponent(() => import("./_nuxt/index-DvGFjcK1.js").then((r) => r["default"] || r.default || r));
const LazyCascadeSelect = defineAsyncComponent(() => import("./_nuxt/index-In28GINb.js").then((r) => r["default"] || r.default || r));
const LazyCheckbox = defineAsyncComponent(() => import("./_nuxt/index-C73KTgwG.js").then((r) => r["default"] || r.default || r));
const LazyCheckboxGroup = defineAsyncComponent(() => import("./_nuxt/index-CQKVsXmi.js").then((r) => r["default"] || r.default || r));
const LazyChips = defineAsyncComponent(() => import("./_nuxt/index-gJsUfpSh.js").then((r) => r["default"] || r.default || r));
const LazyColorPicker = defineAsyncComponent(() => import("./_nuxt/index-CbM1-Plr.js").then((r) => r["default"] || r.default || r));
const LazyDatePicker = defineAsyncComponent(() => import("./_nuxt/index-jbiUtL-s.js").then((r) => r["default"] || r.default || r));
const LazyDropdown = defineAsyncComponent(() => import("./_nuxt/index-C4w4IQPM.js").then((r) => r["default"] || r.default || r));
const LazyFloatLabel = defineAsyncComponent(() => import("./_nuxt/index-57FAD3xU.js").then((r) => r["default"] || r.default || r));
const LazyFluid = defineAsyncComponent(() => import("./_nuxt/index-SJ2uaitM.js").then((r) => r["default"] || r.default || r));
const LazyIconField = defineAsyncComponent(() => import("./_nuxt/index-Bpas9BVM.js").then((r) => r["default"] || r.default || r));
const LazyIftaLabel = defineAsyncComponent(() => import("./_nuxt/index-q1hFdYN7.js").then((r) => r["default"] || r.default || r));
const LazyInputChips = defineAsyncComponent(() => import("./_nuxt/index-CwnoNj7q.js").then((r) => r["default"] || r.default || r));
const LazyInputGroup = defineAsyncComponent(() => import("./_nuxt/index-VCkJJYXD.js").then((r) => r["default"] || r.default || r));
const LazyInputGroupAddon = defineAsyncComponent(() => import("./_nuxt/index-CMIFGKKf.js").then((r) => r["default"] || r.default || r));
const LazyInputIcon = defineAsyncComponent(() => import("./_nuxt/index-Bf2IrflI.js").then((r) => r["default"] || r.default || r));
const LazyInputMask = defineAsyncComponent(() => import("./_nuxt/index-BqTbIvME.js").then((r) => r["default"] || r.default || r));
const LazyInputNumber = defineAsyncComponent(() => import("./_nuxt/index-DFsUalVC.js").then((r) => r["default"] || r.default || r));
const LazyInputOtp = defineAsyncComponent(() => import("./_nuxt/index-jcLCB6Gp.js").then((r) => r["default"] || r.default || r));
const LazyInputSwitch = defineAsyncComponent(() => import("./_nuxt/index-BhKaiWy6.js").then((r) => r["default"] || r.default || r));
const LazyInputText = defineAsyncComponent(() => import("./_nuxt/index-DpA-Wfc2.js").then((r) => r["default"] || r.default || r));
const LazyKnob = defineAsyncComponent(() => import("./_nuxt/index-BFpDF8VU.js").then((r) => r["default"] || r.default || r));
const LazyListbox = defineAsyncComponent(() => import("./_nuxt/index-D726upm9.js").then((r) => r["default"] || r.default || r));
const LazyMultiSelect = defineAsyncComponent(() => import("./_nuxt/index-COIoAQRe.js").then((r) => r["default"] || r.default || r));
const LazyPassword = defineAsyncComponent(() => import("./_nuxt/index-BMSgrSBj.js").then((r) => r["default"] || r.default || r));
const LazyRadioButton = defineAsyncComponent(() => import("./_nuxt/index-zXdTB0aH.js").then((r) => r["default"] || r.default || r));
const LazyRadioButtonGroup = defineAsyncComponent(() => import("./_nuxt/index-CWmXcqSB.js").then((r) => r["default"] || r.default || r));
const LazyRating = defineAsyncComponent(() => import("./_nuxt/index-DCjbwIv1.js").then((r) => r["default"] || r.default || r));
const LazySelect = defineAsyncComponent(() => import("./_nuxt/index-XM6GreCt.js").then((r) => r["default"] || r.default || r));
const LazySelectButton = defineAsyncComponent(() => import("./_nuxt/index-JeSp0FVz.js").then((r) => r["default"] || r.default || r));
const LazySlider = defineAsyncComponent(() => import("./_nuxt/index-Nmuvprfl.js").then((r) => r["default"] || r.default || r));
const LazyTextarea = defineAsyncComponent(() => import("./_nuxt/index-Bpg9eEL7.js").then((r) => r["default"] || r.default || r));
const LazyToggleButton = defineAsyncComponent(() => import("./_nuxt/index-Csj8DHoC.js").then((r) => r["default"] || r.default || r));
const LazyToggleSwitch = defineAsyncComponent(() => import("./_nuxt/index-CttgT9iJ.js").then((r) => r["default"] || r.default || r));
const LazyTreeSelect = defineAsyncComponent(() => import("./_nuxt/index-BXHEwCZn.js").then((r) => r["default"] || r.default || r));
const LazyButton = defineAsyncComponent(() => import("./_nuxt/index-B4-frvJ5.js").then((r) => r["default"] || r.default || r));
const LazyButtonGroup = defineAsyncComponent(() => import("./_nuxt/index-Ch5w0MXw.js").then((r) => r["default"] || r.default || r));
const LazySpeedDial = defineAsyncComponent(() => import("./_nuxt/index-Bi2ik-QR.js").then((r) => r["default"] || r.default || r));
const LazySplitButton = defineAsyncComponent(() => import("./_nuxt/index-x3IvEzPD.js").then((r) => r["default"] || r.default || r));
const LazyColumn = defineAsyncComponent(() => import("./_nuxt/index-BbuP4IHs.js").then((r) => r["default"] || r.default || r));
const LazyRow = defineAsyncComponent(() => import("./_nuxt/index-DSOu9_gL.js").then((r) => r["default"] || r.default || r));
const LazyColumnGroup = defineAsyncComponent(() => import("./_nuxt/index-BcYyZHOS.js").then((r) => r["default"] || r.default || r));
const LazyDataTable = defineAsyncComponent(() => import("./_nuxt/index-C8eh-f8W.js").then((r) => r["default"] || r.default || r));
const LazyDataView = defineAsyncComponent(() => import("./_nuxt/index-ytU1dwjF.js").then((r) => r["default"] || r.default || r));
const LazyOrderList = defineAsyncComponent(() => import("./_nuxt/index-C7Q91rEw.js").then((r) => r["default"] || r.default || r));
const LazyOrganizationChart = defineAsyncComponent(() => import("./_nuxt/index-CN98VMwB.js").then((r) => r["default"] || r.default || r));
const LazyPaginator = defineAsyncComponent(() => import("./_nuxt/index-B6Quh_E4.js").then((r) => r["default"] || r.default || r));
const LazyPickList = defineAsyncComponent(() => import("./_nuxt/index-D-DL78qb.js").then((r) => r["default"] || r.default || r));
const LazyTree = defineAsyncComponent(() => import("./_nuxt/index-C0ZGZ3GF.js").then((r) => r["default"] || r.default || r));
const LazyTreeTable = defineAsyncComponent(() => import("./_nuxt/index-tgdPSMBK.js").then((r) => r["default"] || r.default || r));
const LazyTimeline = defineAsyncComponent(() => import("./_nuxt/index-CYnsHLEM.js").then((r) => r["default"] || r.default || r));
const LazyVirtualScroller = defineAsyncComponent(() => import("./_nuxt/index-BSJgKSdj.js").then((r) => r["default"] || r.default || r));
const LazyAccordion = defineAsyncComponent(() => import("./_nuxt/index-BGyX5TpC.js").then((r) => r["default"] || r.default || r));
const LazyAccordionPanel = defineAsyncComponent(() => import("./_nuxt/index-ChIpHQfZ.js").then((r) => r["default"] || r.default || r));
const LazyAccordionHeader = defineAsyncComponent(() => import("./_nuxt/index-DKlsuZDA.js").then((r) => r["default"] || r.default || r));
const LazyAccordionContent = defineAsyncComponent(() => import("./_nuxt/index-CHmmVRBL.js").then((r) => r["default"] || r.default || r));
const LazyAccordionTab = defineAsyncComponent(() => import("./_nuxt/index-DZJVZynR.js").then((r) => r["default"] || r.default || r));
const LazyCard = defineAsyncComponent(() => import("./_nuxt/index-7WLxQBDe.js").then((r) => r["default"] || r.default || r));
const LazyDeferredContent = defineAsyncComponent(() => import("./_nuxt/index-BUux2TFu.js").then((r) => r["default"] || r.default || r));
const LazyDivider = defineAsyncComponent(() => import("./_nuxt/index-CR_rQzxl.js").then((r) => r["default"] || r.default || r));
const LazyFieldset = defineAsyncComponent(() => import("./_nuxt/index-Degy8r9-.js").then((r) => r["default"] || r.default || r));
const LazyPanel = defineAsyncComponent(() => import("./_nuxt/index-gamQ7kWx.js").then((r) => r["default"] || r.default || r));
const LazyScrollPanel = defineAsyncComponent(() => import("./_nuxt/index-BPHDNw2y.js").then((r) => r["default"] || r.default || r));
const LazySplitter = defineAsyncComponent(() => import("./_nuxt/index-CHDn_h4P.js").then((r) => r["default"] || r.default || r));
const LazySplitterPanel = defineAsyncComponent(() => import("./_nuxt/index-Ck-mDc9R.js").then((r) => r["default"] || r.default || r));
const LazyStepper = defineAsyncComponent(() => import("./_nuxt/index-DUUWP1C8.js").then((r) => r["default"] || r.default || r));
const LazyStepList = defineAsyncComponent(() => import("./_nuxt/index-B4wov4W6.js").then((r) => r["default"] || r.default || r));
const LazyStep = defineAsyncComponent(() => import("./_nuxt/index-C4QRdJe-.js").then((r) => r["default"] || r.default || r));
const LazyStepItem = defineAsyncComponent(() => import("./_nuxt/index-DA63X8rB.js").then((r) => r["default"] || r.default || r));
const LazyStepPanels = defineAsyncComponent(() => import("./_nuxt/index-B_6ByNet.js").then((r) => r["default"] || r.default || r));
const LazyStepPanel = defineAsyncComponent(() => import("./_nuxt/index-CqgUCjlu.js").then((r) => r["default"] || r.default || r));
const LazyTabView = defineAsyncComponent(() => import("./_nuxt/index-D1JCk031.js").then((r) => r["default"] || r.default || r));
const LazyTabs = defineAsyncComponent(() => import("./_nuxt/index-C0WzHkwM.js").then((r) => r["default"] || r.default || r));
const LazyTabList = defineAsyncComponent(() => import("./_nuxt/index-BleInfUi.js").then((r) => r["default"] || r.default || r));
const LazyTab = defineAsyncComponent(() => import("./_nuxt/index-DukYmd3H.js").then((r) => r["default"] || r.default || r));
const LazyTabPanels = defineAsyncComponent(() => import("./_nuxt/index-BoEYpePI.js").then((r) => r["default"] || r.default || r));
const LazyTabPanel = defineAsyncComponent(() => import("./_nuxt/index-BVxvwWcN.js").then((r) => r["default"] || r.default || r));
const LazyToolbar = defineAsyncComponent(() => import("./_nuxt/index-0jJ2H3GE.js").then((r) => r["default"] || r.default || r));
const LazyConfirmDialog = defineAsyncComponent(() => import("./_nuxt/index-B2qeW2rU.js").then((r) => r["default"] || r.default || r));
const LazyConfirmPopup = defineAsyncComponent(() => import("./_nuxt/index-D8fAytL3.js").then((r) => r["default"] || r.default || r));
const LazyDialog = defineAsyncComponent(() => import("./_nuxt/index-D_7vtSvx.js").then((r) => r["default"] || r.default || r));
const LazyDrawer = defineAsyncComponent(() => import("./_nuxt/index--9iySMjH.js").then((r) => r["default"] || r.default || r));
const LazyDynamicDialog = defineAsyncComponent(() => import("./_nuxt/index-reQK9ZI8.js").then((r) => r["default"] || r.default || r));
const LazyOverlayPanel = defineAsyncComponent(() => import("./_nuxt/index-BCrIm9-3.js").then((r) => r["default"] || r.default || r));
const LazyPopover = defineAsyncComponent(() => import("./_nuxt/index-CloEGlYu.js").then((r) => r["default"] || r.default || r));
const LazyFileUpload = defineAsyncComponent(() => import("./_nuxt/index-D1-VQhX-.js").then((r) => r["default"] || r.default || r));
const LazyBreadcrumb = defineAsyncComponent(() => import("./_nuxt/index-B8Ab9RQ0.js").then((r) => r["default"] || r.default || r));
const LazyContextMenu = defineAsyncComponent(() => import("./_nuxt/index-NKgWP0KO.js").then((r) => r["default"] || r.default || r));
const LazyDock = defineAsyncComponent(() => import("./_nuxt/index-Ctdfdi7z.js").then((r) => r["default"] || r.default || r));
const LazyMenu = defineAsyncComponent(() => import("./_nuxt/index-BYy21lZk.js").then((r) => r["default"] || r.default || r));
const LazyMenubar = defineAsyncComponent(() => import("./_nuxt/index-Df3kS6gN.js").then((r) => r["default"] || r.default || r));
const LazyMegaMenu = defineAsyncComponent(() => import("./_nuxt/index-CHt88Xsh.js").then((r) => r["default"] || r.default || r));
const LazyPanelMenu = defineAsyncComponent(() => import("./_nuxt/index-DVFMkiGz.js").then((r) => r["default"] || r.default || r));
const LazySteps = defineAsyncComponent(() => import("./_nuxt/index-E4ES8BND.js").then((r) => r["default"] || r.default || r));
const LazyTabMenu = defineAsyncComponent(() => import("./_nuxt/index--39iKKP5.js").then((r) => r["default"] || r.default || r));
const LazyTieredMenu = defineAsyncComponent(() => import("./_nuxt/index-MZ-cImRa.js").then((r) => r["default"] || r.default || r));
const LazyMessage = defineAsyncComponent(() => import("./_nuxt/index-TrDzAUuj.js").then((r) => r["default"] || r.default || r));
const LazyInlineMessage = defineAsyncComponent(() => import("./_nuxt/index-B_w1Glrd.js").then((r) => r["default"] || r.default || r));
const LazyToast = defineAsyncComponent(() => import("./_nuxt/index-uWDf1Kwn.js").then((r) => r["default"] || r.default || r));
const LazyCarousel = defineAsyncComponent(() => import("./_nuxt/index-CmleLIUs.js").then((r) => r["default"] || r.default || r));
const LazyGalleria = defineAsyncComponent(() => import("./_nuxt/index-gVzvd-uu.js").then((r) => r["default"] || r.default || r));
const LazyImage = defineAsyncComponent(() => import("./_nuxt/index-Cy9ZqKZ8.js").then((r) => r["default"] || r.default || r));
const LazyImageCompare = defineAsyncComponent(() => import("./_nuxt/index-DbBvaf0e.js").then((r) => r["default"] || r.default || r));
const LazyAvatar = defineAsyncComponent(() => import("./_nuxt/index-CT0vkNeU.js").then((r) => r["default"] || r.default || r));
const LazyAvatarGroup = defineAsyncComponent(() => import("./_nuxt/index-Cko2PVuC.js").then((r) => r["default"] || r.default || r));
const LazyBadge = defineAsyncComponent(() => import("./_nuxt/index-DbMJ_aPl.js").then((r) => r["default"] || r.default || r));
const LazyBlockUI = defineAsyncComponent(() => import("./_nuxt/index-CRAE891s.js").then((r) => r["default"] || r.default || r));
const LazyChip = defineAsyncComponent(() => import("./_nuxt/index-XMxvkilb.js").then((r) => r["default"] || r.default || r));
const LazyInplace = defineAsyncComponent(() => import("./_nuxt/index-XzxX7P-1.js").then((r) => r["default"] || r.default || r));
const LazyMeterGroup = defineAsyncComponent(() => import("./_nuxt/index-CimhaUQk.js").then((r) => r["default"] || r.default || r));
const LazyOverlayBadge = defineAsyncComponent(() => import("./_nuxt/index-Ee1-jr7u.js").then((r) => r["default"] || r.default || r));
const LazyScrollTop = defineAsyncComponent(() => import("./_nuxt/index-Cjwesabz.js").then((r) => r["default"] || r.default || r));
const LazySkeleton = defineAsyncComponent(() => import("./_nuxt/index-B47IRpvj.js").then((r) => r["default"] || r.default || r));
const LazyProgressBar = defineAsyncComponent(() => import("./_nuxt/index-CS2xjo2T.js").then((r) => r["default"] || r.default || r));
const LazyProgressSpinner = defineAsyncComponent(() => import("./_nuxt/index-Cqp0kO1G.js").then((r) => r["default"] || r.default || r));
const LazyTag = defineAsyncComponent(() => import("./_nuxt/index-ChNvRVdq.js").then((r) => r["default"] || r.default || r));
const LazyTerminal = defineAsyncComponent(() => import("./_nuxt/index-DITHsrVD.js").then((r) => r["default"] || r.default || r));
const LazyForm = defineAsyncComponent(() => import("./_nuxt/index-DWgC5dbk.js").then((r) => r["default"] || r.default || r));
const LazyFormField = defineAsyncComponent(() => import("./_nuxt/index-D0NYGxgE.js").then((r) => r["default"] || r.default || r));
...
const layouts = {
  center: defineAsyncComponent(() => import("./_nuxt/center-C51tK6aO.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-Dr1fFL4f.js").then((m) => m.default || m)),
  hmf: defineAsyncComponent(() => import("./_nuxt/hmf-CjUX7mXG.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DPYvHsdg.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BPLZ3cXC.js"));
