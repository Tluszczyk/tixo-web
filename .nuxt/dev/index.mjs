...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, getResponseStatus, createError, getRequestProtocol, getRequestHost, getQuery as getQuery$1, removeResponseHeader, readBody, setHeader, getHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getResponseStatusText } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve as resolve$1, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, hasProtocol, withHttps, withoutTrailingSlash, withTrailingSlash, joinRelativeURL, withLeadingSlash, withBase, decodePath, parsePath, stringifyQuery, parseQuery, encodePath, stringifyParsedURL } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/vue/server-renderer/index.mjs';
import destr, { destr as destr$1 } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/destr/dist/index.mjs';
...
import { createStorage, prefixStorage } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/unstorage/dist/index.mjs';
...
import consola, { createConsola, consola as consola$1 } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/nitropack/node_modules/source-map/source-map.js';
import devalue from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { toValue, isVNode, isRef } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/vue/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/errx/dist/index.js';
...
import { dirname as dirname$1, resolve as resolve$2 } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/unhead/dist/utils.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/tluszczyk/dev/Multilanguage/tixo/tixo-web/.data/kv"}));
...
const _fQkB_fzP2E2mZRRCAm3zXr9FA5un7jHEezCNqOsH2yw = (function(nitro) {
...
const rootDir = "/home/tluszczyk/dev/Multilanguage/tixo/tixo-web";
...
const _TE7bNvfEVEIQQYUIQ_B5w23K_cxd2jyHC71OHeFGkW8 = (nitroApp) => {
...
const plugins = [
  _fQkB_fzP2E2mZRRCAm3zXr9FA5un7jHEezCNqOsH2yw,
_9LYXMAqgvjCNLxNitJY6AVrf8tQx3twwvR89Vc66ZOg,
_BQcdg4CGQ4_SMEDo6Q9VZSFkJlqpwzQPF24d7V_cNQ,
_TE7bNvfEVEIQQYUIQ_B5w23K_cxd2jyHC71OHeFGkW8,
...
const getServerEntry = () => import('file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const __Mvc88 = eventHandler(async (e) => {
  const siteConfig = getSiteConfig(e);
  const nitroOrigin = getNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _FAMDJv = defineEventHandler(async (e) => {
...
const _QZr5sg = defineEventHandler(async (e) => {
...
const _6n11uA = defineEventHandler(async (e) => {
  const query = getQuery$1(e);
...
const _lazy_V1pLm9 = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__site-config__/debug.json', handler: __Mvc88, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _FAMDJv, lazy: false, middleware: false, method: undefined },
  ...
  { route: '/__robots__/debug.json', handler: _QZr5sg, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _6n11uA, lazy: false, middleware: false, method: undefined },
