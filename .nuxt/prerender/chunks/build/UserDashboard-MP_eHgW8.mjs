import { _ as _export_sfc, B as BaseButton } from './server.mjs';
import { defineComponent, computed, mergeProps, withCtx, createTextVNode, unref, useSSRContext } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderList } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/vue/server-renderer/index.mjs';
import { _ as _sfc_main$1 } from './GameListItem-BiqWjvUL.mjs';
...
import VChart from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/vue-echarts/dist/index.js';
    ...
    const stats = computed(() => {
      ...
      myGames.forEach((g) => {
        ...
        if (g.winner === "D" || g.winner === "TIE") ties++;
          ...
          const mySymbol = g.xPlayerId === ((_a = props.user) == null ? void 0 : _a.$id) ? "X" : "O";
