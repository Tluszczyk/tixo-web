import { defineComponent, computed, mergeProps, ref, watch, unref, withCtx, createTextVNode, toDisplayString, createVNode, useSSRContext } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrInterpolate } from 'file:///home/tluszczyk/dev/Multilanguage/tixo/tixo-web/node_modules/vue/server-renderer/index.mjs';
...
import { u as users } from './games-B7zgyYbT.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div>`);
      if (!((_b = __props.game.requestedOpponentId) == null ? void 0 : _b.startsWith("AI_X")) && ((_c = xPlayer.value) == null ? void 0 : _c.$id)) {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a2, _b2;
            if (_push2) {
              _push2(`${ssrInterpolate(((_a2 = xPlayer.value) == null ? void 0 : _a2.name) || (__props.game.xPlayerId ? __props.game.xPlayerId.substring(0, 12) : "..."))}`);
            } else {
              return [
                createTextVNode(toDisplayString(((_b2 = xPlayer.value) == null ? void 0 : _b2.name) || (__props.game.xPlayerId ? __props.game.xPlayerId.substring(0, 12) : "...")), 1)
              ];
            }
          }),
          _: 1
        ...
        _push(`<span class="text-[10px] sm:text-xs mono text-app-text-muted opacity-70 font-bold truncate max-w-[80px] sm:max-w-[100px]">${ssrInterpolate(((_d = __props.game.requestedOpponentId) == null ? void 0 : _d.startsWith("AI_X")) ? "Tixo AI" : "...")}</span>`);
      }
      ...
      if ((_e = oPlayer.value) == null ? void 0 : _e.rating) {
      ...
      _push(`</div>`);
      if (!((_f = __props.game.requestedOpponentId) == null ? void 0 : _f.startsWith("AI_O")) && !__props.game.isOnDevice && ((_g = oPlayer.value) == null ? void 0 : _g.$id)) {
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            var _a2, _b2;
            if (_push2) {
              _push2(`${ssrInterpolate(((_a2 = oPlayer.value) == null ? void 0 : _a2.name) || (__props.game.oPlayerId ? __props.game.oPlayerId.substring(0, 12) : "..."))}`);
            } else {
              return [
                createTextVNode(toDisplayString(((_b2 = oPlayer.value) == null ? void 0 : _b2.name) || (__props.game.oPlayerId ? __props.game.oPlayerId.substring(0, 12) : "...")), 1)
              ];
            }
          }),
          _: 1
        ...
        _push(`<span class="text-[10px] sm:text-xs mono text-app-text-muted opacity-70 font-bold truncate max-w-[80px] sm:max-w-[100px]">${ssrInterpolate(((_h = __props.game.requestedOpponentId) == null ? void 0 : _h.startsWith("AI_O")) ? "Tixo AI" : __props.game.isOnDevice && !((_i = __props.game.requestedOpponentId) == null ? void 0 : _i.startsWith("AI_X")) ? ((_j = oPlayer.value) == null ? void 0 : _j.name) || "Local Player" : "...")}</span>`);
      }
  ...
  setup(__props) {
    ...
    const isMyTurn = computed(() => {
      ...
      if (!props.game || !props.currentUser || props.game.status !== GameStatus.IN_PROGRESS)
        return false;
      if (props.game.isOnDevice) return props.game.creatorId === ((_a = props.currentUser) == null ? void 0 : _a.$id);
      return props.game.nextPlayerId === ((_b = props.currentUser) == null ? void 0 : _b.$id);
    });
    return (_ctx, _push, _parent, _attrs) => {
