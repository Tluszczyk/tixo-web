...
import { defineComponent, ref, computed, watch, mergeProps, withCtx, createTextVNode, unref, openBlock, createBlock, createVNode, toDisplayString, createCommentVNode, Fragment, Transition, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderClass, ssrRenderStyle, ssrInterpolate, ssrRenderAttrs } from 'vue/server-renderer';
...
import { _ as _sfc_main$4 } from './CreateGameDialog-BV9Lf4Fz.mjs';
import { c as coordToIndex, g as getSmallBoard, a as check3x3Winner, M as MatchTimeline, _ as _sfc_main$3, G as GameAnalyticsDashboard, b as _sfc_main$1$1, d as _sfc_main$2$1, e as _sfc_main$5, r as rebuildGameState, P as Player, f as getBestMove, A as AI_MODELS, i as isCellAvailable } from './GameHeader-B8l1V8OH.mjs';
  ...
  setup(__props) {
      ...
      try {
        ...
        if (success) {
          ...
          if (updatedGame) {
            ...
            const { tablesDB } = await import('./server.mjs').then((n) => n.v);
    ...
    watch(() => route.params.id, (newId) => {
      if (newId) {
        ...
        import('./server.mjs').then((n) => n.v).then(({ realtime }) => {
          realtime.subscribe(
