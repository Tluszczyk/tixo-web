...
import { c as coordToIndex, g as getSmallBoard, a as check3x3Winner, M as MatchTimeline, _ as _sfc_main$3, G as GameAnalyticsDashboard, b as _sfc_main$1, d as _sfc_main$2, e as _sfc_main$5, r as rebuildGameState, f as getBestMove, A as AI_MODELS, i as isCellAvailable, P as Player } from './GameHeader-BbjoHctG.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "contents" }, _attrs))} data-v-812c5b09>`);
      _push(ssrRenderComponent(DashboardLayout, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (loading.value) {
              _push2(`<div class="flex flex-col items-center justify-center min-h-[60vh]" data-v-812c5b09${_scopeId}><i class="pi pi-spin pi-spinner text-4xl text-blue-500 mb-4" data-v-812c5b09${_scopeId}></i><p class="text-app-text-muted opacity-40 animate-pulse" data-v-812c5b09${_scopeId}>Loading game state...</p></div>`);
            } else if (!game.value) {
              _push2(`<div class="flex flex-col items-center justify-center min-h-[60vh] text-center" data-v-812c5b09${_scopeId}><i class="pi pi-exclamation-triangle text-4xl text-amber-500 mb-4" data-v-812c5b09${_scopeId}></i><h2 class="text-2xl font-bold text-app-text mb-2" data-v-812c5b09${_scopeId}>Game Not Found</h2><p class="text-app-text-muted opacity-40 mb-6" data-v-812c5b09${_scopeId}> The game you&#39;re looking for doesn&#39;t exist or has been removed. </p><button class="px-6 py-2 rounded-xl bg-glass-white text-app-text font-bold hover:bg-indigo-500/20 transition-all border border-glass-border" data-v-812c5b09${_scopeId}> Go Back </button></div>`);
            } else {
              _push2(`<div class="flex flex-col pb-12 h-full min-h-[calc(100vh-120px)] overflow-x-hidden px-4" data-v-812c5b09${_scopeId}><div class="${ssrRenderClass([game.value.status === unref(GameStatus).FINISHED || game.value.status === unref(GameStatus).CANCELLED ? "lg:grid-cols-[120px_1fr_var(--analytics-width)]" : "lg:grid-cols-[120px_1fr] lg:max-w-7xl mx-auto", "grid grid-cols-1 gap-12 transition-all duration-1000 ease-in-out w-full"])}" style="${ssrRenderStyle({ "--analytics-width": showAnalytics.value || isGuest.value ? "800px" : "400px" })}" data-v-812c5b09${_scopeId}>`);
              ...
              _push2(`<div class="flex flex-col items-center justify-center py-4 lg:py-0 min-h-[75vh] transition-all duration-1000 ease-in-out w-full" data-v-812c5b09${_scopeId}><div class="flex flex-col items-center justify-center space-y-8 lg:space-y-16 w-full" data-v-812c5b09${_scopeId}>`);
              ...
              _push2(`<div class="flex flex-col items-center gap-1 opacity-20 hover:opacity-100 transition-opacity pt-12 border-t border-glass-border w-full" data-v-812c5b09${_scopeId}><span class="text-[8px] font-black uppercase tracking-[0.4em] text-app-text-muted opacity-20" data-v-812c5b09${_scopeId}>Game Session Key</span><span class="text-[9px] mono text-app-text-muted opacity-30" data-v-812c5b09${_scopeId}>${ssrInterpolate(game.value.$id)}</span></div></div></div>`);
              if (game.value.status === unref(GameStatus).FINISHED || game.value.status === unref(GameStatus).CANCELLED) {
                ...
                })}" data-v-812c5b09${_scopeId}>`);
                if (isGuest.value) {
                  _push2(`<div class="absolute inset-0 z-50 flex items-center justify-center p-8 bg-void/20 backdrop-blur-sm" data-v-812c5b09${_scopeId}><div class="glass p-12 rounded-[3rem] border-indigo-500/30 flex flex-col items-center text-center space-y-8 shadow-2xl" data-v-812c5b09${_scopeId}><div class="w-20 h-20 rounded-3xl glass flex items-center justify-center border-indigo-500/20 text-indigo-500" data-v-812c5b09${_scopeId}><i class="pi pi-lock text-3xl" data-v-812c5b09${_scopeId}></i></div><div class="space-y-2" data-v-812c5b09${_scopeId}><h4 class="text-2xl font-black text-app-text uppercase italic" data-v-812c5b09${_scopeId}>Intelligence Locked</h4><p class="text-[10px] font-black uppercase tracking-widest text-app-text-muted opacity-40" data-v-812c5b09${_scopeId}>Log in to unlock full move analysis</p></div><button class="px-10 py-4 bg-indigo-600 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl hover:bg-indigo-500 transition-all shadow-2xl active:scale-[0.98]" data-v-812c5b09${_scopeId}> Authorize to Unlock </button></div></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (!showAnalytics.value && !isGuest.value) {
                  _push2(`<div class="w-full flex justify-center" data-v-812c5b09${_scopeId}><button class="group relative flex flex-col items-center gap-6 p-8 rounded-[2.5rem] glass border-glass-border hover:border-indigo-500/30 transition-all duration-700 hover:scale-105 w-full max-w-sm" data-v-812c5b09${_scopeId}><div class="w-20 h-20 rounded-2xl glass flex items-center justify-center border-indigo-500/20 text-indigo-500 shadow-2xl shadow-indigo-500/10 group-hover:bg-indigo-500 group-hover:text-white transition-all duration-500" data-v-812c5b09${_scopeId}><i class="pi pi-bolt text-4xl" data-v-812c5b09${_scopeId}></i></div><div class="space-y-2 text-center" data-v-812c5b09${_scopeId}><h4 class="text-lg font-black text-app-text uppercase italic tracking-tight" data-v-812c5b09${_scopeId}>Tactical Synthesis</h4><p class="text-[9px] font-black uppercase tracking-[0.2em] text-app-text-muted opacity-20 group-hover:opacity-40 transition-opacity" data-v-812c5b09${_scopeId}>Unlock deep move evaluations</p></div></button></div>`);
                } else {
                  _push2(`<div class="${ssrRenderClass([{ "blur-md": isGuest.value }, "h-full w-full"])}" data-v-812c5b09${_scopeId}>`);
                  if (showAnalytics.value || isGuest.value) {
              ...
              if ((game.value.status === unref(GameStatus).FINISHED || game.value.status === unref(GameStatus).CANCELLED) && game.value) {
                _push2(`<div class="lg:hidden mt-8 px-4 pb-12 relative" data-v-812c5b09${_scopeId}><h3 class="text-xl font-black text-app-text uppercase italic mb-6" data-v-812c5b09${_scopeId}> Tactical Analysis<span class="text-indigo-500" data-v-812c5b09${_scopeId}>.</span></h3>`);
                if (isGuest.value) {
                  _push2(`<div class="absolute inset-0 z-50 flex items-center justify-center p-8 bg-void/20 backdrop-blur-sm" data-v-812c5b09${_scopeId}><div class="glass p-8 rounded-[2rem] border-indigo-500/30 flex flex-col items-center text-center space-y-6 shadow-2xl" data-v-812c5b09${_scopeId}><p class="text-[10px] font-black uppercase tracking-widest text-app-text-muted opacity-40" data-v-812c5b09${_scopeId}>Log in to unlock full move analysis</p><button class="px-8 py-3 bg-indigo-600 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-xl hover:bg-indigo-500 transition-all shadow-2xl" data-v-812c5b09${_scopeId}> Authorize to Unlock </button></div></div>`);
                } else {
                  _push2(`<!---->`);
                }
                if (!showAnalytics.value && !isGuest.value) {
                  _push2(`<div class="py-12 flex flex-col items-center justify-center glass rounded-3xl border border-glass-border space-y-6 shadow-2xl" data-v-812c5b09${_scopeId}><p class="text-[10px] font-black uppercase tracking-widest text-app-text-muted opacity-20" data-v-812c5b09${_scopeId}> Tactical data is available for review </p><button class="px-10 py-4 bg-indigo-600 text-white text-xs font-black uppercase tracking-[0.2em] rounded-2xl hover:bg-indigo-500 transition-all shadow-2xl" data-v-812c5b09${_scopeId}> Request Analysis </button></div>`);
                } else {
                  _push2(`<div class="${ssrRenderClass({ "blur-md pointer-events-none": isGuest.value })}" data-v-812c5b09${_scopeId}>`);
                  _push2(ssrRenderComponent(GameAnalyticsDashboard, {
                    "game-id": game.value.$id,
                    winner: game.value.winner,
                    "selected-turn": selectedHistoryIndex.value,
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-812c5b09"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-JgthtJKB.mjs.map
