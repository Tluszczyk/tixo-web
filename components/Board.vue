...
<template>
  ...
  >
    <div class="relative">
      <!-- Top Labels (A-I) -->
      <div
        class="absolute -top-6 lg:-top-12 left-0 right-0 grid grid-cols-3 gap-2 lg:gap-4 px-2 lg:px-6 pointer-events-none h-6 lg:h-12"
      >
      ...
      <!-- Left Labels (1-9) -->
      <div
        class="absolute -left-6 lg:-left-12 top-0 bottom-0 grid grid-rows-3 gap-2 lg:gap-4 py-2 lg:py-6 pointer-events-none w-6 lg:w-12"
      >
